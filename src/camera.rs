...
pub const VIEWPORT_X_OFFSET: i32 = BTERM_WIDTH / 2;
pub const VIEWPORT_Y_OFFSET: i32 = BTERM_HEIGHT / 2;
pub const VIEWPORT_WIDTH: i32 = BTERM_WIDTH;
pub const VIEWPORT_HEIGHT: i32 = BTERM_HEIGHT;
