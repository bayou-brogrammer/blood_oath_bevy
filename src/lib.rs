...
use bracket_bevy::BracketCamera;
pub use prelude::*;
...
pub fn app() -> Option<App> {
    ...
    app.add_plugin(bterm::setup_bterm())
...
fn setup(mut commands: Commands) {
    ...
    // cam.transform.scale = Vec3::new(0.9, 0.9, 1.0);
    commands.spawn_bundle(cam).insert(BracketCamera);
}
