...
impl BuilderChain {
    fn random_start_position(&self, rng: &mut RandomNumbers) -> (XStart, YStart) {
    ...
    pub fn random_shape_builder(&mut self, rng: &mut RandomNumbers) {
    ...
    pub fn random_room_builder(&mut self, master: &mut ResMut<TemplateMaster>, rng: &mut RandomNumbers) {
