...
impl BspInteriorBuilder {
    ...
    fn build(&mut self, builder: &mut MapBuilder, rng: &mut RandomNumbers) {
        ...
        self.rects.push(Rect::with_size(1, 1, builder.map.width - 1, builder.map.height - 1)); // Start with a single map-sized rectangle
    ...
    fn add_subrects(&mut self, rect: Rect, rng: &mut RandomNumbers) {
